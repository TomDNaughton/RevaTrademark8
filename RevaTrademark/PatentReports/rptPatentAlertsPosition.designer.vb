...
Partial Public Class rptPatentAlertsPosition
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptPatentAlertsPosition))
        ...
        Me.ContactIDHeader.KeepTogether = True
        ...
        'PatentIDHeader
        '
        Me.PatentIDHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Line112})
        Me.PatentIDHeader.DataField = "PatentID"
        Me.PatentIDHeader.Height = 0.01041667!
        Me.PatentIDHeader.Name = "PatentIDHeader"
        '
        'PatentIDFooter
        '
        Me.PatentIDFooter.CanShrink = True
        Me.PatentIDFooter.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.subrptPatentActions})
        Me.PatentIDFooter.Height = 0.18!
        ...
        Me.subrptPatentActions.Left = 1.875!
        ...
        Me.subrptPatentActions.Top = 0.0!
        Me.subrptPatentActions.Width = 7.333333!
        '
        'rptPatentAlertsPosition
        '
        ...
        OleDBDataSource1.SQL = "Select * from qvwReportPatentAlertsPosition" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "order by ContactName"
