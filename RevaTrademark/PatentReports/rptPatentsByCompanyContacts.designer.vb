...
Partial Public Class rptPatentsByCompanyContacts
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptPatentsByCompanyContacts))
        ...
        Me.PatentIDHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.PatentName, Me.Label4, Me.Jurisdiction, Me.Label5, Me.ApplicationNumber, Me.PatentNumber, Me.Label6, Me.Line3})
        Me.PatentIDHeader.DataField = "PatentID"
        Me.PatentIDHeader.GroupKeepTogether = DataDynamics.ActiveReports.GroupKeepTogether.All
        Me.PatentIDHeader.Height = 0.5520833!
        ...
        '
        'rptPatentsByCompanyContacts
        '
        OleDBDataSource1.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\RevaVB\RevaTrademark\RevaTrademar" & _
            "k.mdb"
        OleDBDataSource1.SQL = "Select * from qvwReportPatentContacts order by companyname, Patentname, Patentid"
